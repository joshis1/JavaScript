...
/** TBD ?? Can we merge Alert Dialog and Error Dialog or better keep it separate ?? 
 *  Keeping it separate makes it more declarative and simple code. 
*/

export default function ErrorDialog(alertProps) {
